 ...
 * **************************************************************************
 * Module:	$Source: /cvsroot/webtranslator/source/src/com/javanetworkframework/rb/tester/FreeTranslationTranslatorTester.java,v $
 * **************************************************************************
...
public class FreeTranslationTranslatorTester {
	...
	public static void main(String[] args) {
		...
		for(Iterator iterator=FreeTranslationTranslatorRB.SgetSupportedTranslations().iterator();
		    iterator.hasNext();) {
			...
			JOptionPane.showMessageDialog(null, output, "FreeTranslationTranslatorTester", JOptionPane.INFORMATION_MESSAGE);
		}
