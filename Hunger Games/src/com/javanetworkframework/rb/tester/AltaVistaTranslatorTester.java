 ...
 * **************************************************************************
 * Module:	$Source: /cvsroot/webtranslator/source/src/com/javanetworkframework/rb/tester/AltaVistaTranslatorTester.java,v $
 * **************************************************************************
...
public class AltaVistaTranslatorTester {
	...
	public static void main(String[] args) {
		...
		for(Iterator iterator=AltaVistaTranslatorRB.SgetSupportedTranslations().iterator();
		    iterator.hasNext();) {
			...
			System.out.println("Translating from " + srcLoc + " to " + dstLoc + "...");
			...
			JOptionPane.showMessageDialog(null, output, "AltaVistaTranslatorTester", JOptionPane.INFORMATION_MESSAGE);
		}
