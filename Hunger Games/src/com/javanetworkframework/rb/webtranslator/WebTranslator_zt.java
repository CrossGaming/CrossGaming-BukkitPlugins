 ...
 * **************************************************************************
 * Module:	$Source: /cvsroot/webtranslator/source/src/com/javanetworkframework/rb/webtranslator/WebTranslator_zt.java,v $
 * **************************************************************************
...
/** Web Translator Resource Bundle for Traditional Chinese (zt).
 *  This class is necessary because if it didn't exist, the parent class WebTranslator would be used
 ...
 * @version 1.0
 */
public class WebTranslator_zt extends WebTranslator {
